        ...
        >
            <div className="absolute inset-0">
                ...
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(180deg, rgba(13,27,42,0.62) 0%, rgba(13,27,42,0.34) 45%, rgba(13,27,42,0.9) 100%)",
                    }}
                />
            </div>
            ...
            >
                ...
                <g
                    style={{
                        opacity: 0,
                        animation: "harbourReveal 0.8s ease forwards 2.0s",
                    }}
                >
                    ...
                    <circle
                        ...
                        fill="#c8a96e"
                        style={{
                            animation: "sawyerDotCore 3s 2.0s ease-in-out infinite",
                        }}
                    />
                    ...
                    <g
                        style={{
                            opacity: 0,
                            animation: "compassRoseFadeIn 1.8s ease forwards 2.2s",
                        }}
                    >
                        <circle
                            cx={CX}
                        ...
                        <g
                            style={{
                                ...
                                animation:
                                    "diamondIn 1.4s cubic-bezier(0.34,1.56,0.64,1) forwards",
                            }}
                        >
            ...
            <div className="relative z-10 min-h-[100svh] md:h-full flex items-center px-[var(--sawyer-edge-pad)] pt-28 pb-24">
                <div className="max-w-4xl">
                    ...
                    >
                        Institutions are under pressure to modernize without compromising
                        stability.
                    </motion.p>
